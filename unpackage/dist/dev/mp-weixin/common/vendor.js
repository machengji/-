...
function initWrapper(protocols2) {
  ...
  return function wrapper(methodName, method) {
    ...
    if (!hasOwn(protocols2, methodName) && !isFunction$1(protocols2.returnValue) || !isFunction$1(method)) {
      return method;
    }
    const protocol = protocols2[methodName];
    if (!protocol && !isFunction$1(protocols2.returnValue)) {
      return function() {
